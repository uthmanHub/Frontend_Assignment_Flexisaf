  ...
  return (
    <div className='mt-5 px-3 md:px-6 lg:px-10'>
      <section className='flex flex-1 justify-between gap-20'>
        <form onSubmit={handleSubmit} className='space-y-5 px-20 py-10 bg-gray-100 w-full'>
        ...
        <div className='w-full'>
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d63045.10710199489!2d7.3586756742029396!3d9.03461943483417!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x104e73d9ee045d79%3A0xea29129d7cdc6855!2sLugbe%20900107%2C%20Federal%20Capital%20Territory!5e0!3m2!1sen!2sng!4v1739419467047!5m2!1sen!2sng" width="600" height="650" style={{border:0}} allowFullScreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
      </section>
    </div>
  );
